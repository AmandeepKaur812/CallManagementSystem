...
<div id="login" class="boxed" style="width:850px;text-align:center;color:black;">
		...
		<br><br></br>
			...
			<table>
				...
				<tr>
					<td align="right"><label>Complain Solution :</label></td>
					<td><%= complain.getComplaintSolution() %></td>
				</tr>	
				<tr>
					<td align="right"><label>Root Cause :</label></td>
					<td><%= complain.getRootCause() %></td>
				</tr>	
				<tr>
					<td align="right"><label>Start Date and Time :</label></td>
					<td><%=complain.getComplaintDate() %></td>
				</tr>
				<tr>
					<td align="right"><label>End Date and Time :</label></td>
					<td><%= complain.getEndDate() %></td>
				</tr>
				<tr>
					
					<td colspan="2">
						<a class="mylinkbutton" href="CMS?tab=finished" style="text-decoration: none;color:black;">Cancel</a>
					</td>
				</tr>
			</table>	
			<br></br>
