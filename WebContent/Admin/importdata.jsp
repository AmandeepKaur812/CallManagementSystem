...
<div id="content">
<div id="login" class="boxed" style="width:450px;text-align:center;height: 350px">

			<h2 class="title" style="text-align:left">Import Data</h2>
<br></br><br></br>			
				<form method="post" action="../ProductDataUpload" id="importme" enctype="multipart/form-data">
					<fieldset>
					<legend></legend>
					<label for="inputtext1">Select CSV File</label>
					<input class="mytextbox" type="file" name="file" id="file" value="" />
					
					<br><br>
					<input class="mybutton" type="submit" name="submit" id="submit" value="Import" style="text-align:center" /></br></br>   
								
					</fieldset>
				</form>	   
				<button class="mybutton"><a href="CMS">Cancel</a></button>  <br></br>
				<%
						ArrayList<String> error = (ArrayList<String>)session.getAttribute("importerror");
	 					...
	 					if(error!=null && !error.equals(""))
	 					{
	      					...
	      					session.setAttribute("importerror",null);
	 					}
	 			     %>
	</div>
</div>
