...
<%
	...
	else
	{
		...
		complain = db.getComplaintDetails(session.getAttribute("complainId").toString());
%>
...
<div id="login" class="boxed" style="width:850px;text-align:center;color:black;">
		...
		<br><br></br>
			...
			<table>
				...
				<tr>
					<td>
					<form action="../AssignToSME" method="post">
						<input class="mybutton" type="submit" name="submit" value="Assign to Engineer" style="text-decoration: none;color:black;"/>
						</form>
					</td>
					<td>
