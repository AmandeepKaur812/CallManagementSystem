...
<div id="content">
<div id="login" class="boxed" style="width:850px;text-align:center;">
		<h2 class="title" style="text-align:left">Call Log</h2>
			
			<form id="searchform" name="searchform" method="post" action="../CustomerSearch">
				
				
					<label for="inputtext1" style="padding: 20px">Enter Customer's Contact No</label>
					<input class="mytextbox" type="text" name="teleno" id="teleno"/>
					
					<input class="mybutton" type="submit" name="submit" id="submit" value="Search" style="text-align:center" /></br>   
					<br>		
			</form>	  
			<%
