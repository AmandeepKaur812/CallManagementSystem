...
/**
 * Servlet Filter implementation class ServiceEngineerLoginChecker
 */
@WebFilter("/ServiceEngineerLoginChecker")
public class ServiceEngineerLoginChecker implements Filter {

	public ServiceEngineerLoginChecker() 
    {}
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException 
	{
		...
		if(session.getAttribute("login")!=null)
		{
			...
			else
			{
				...
				{
					res.sendRedirect("../Management/CMS");
				}
